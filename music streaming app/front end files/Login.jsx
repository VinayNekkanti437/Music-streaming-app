...
const Login = () => {
  ...
  return (
    ...
    <h2 style={{ position: "relative", bottom: "300px", right: "300px", transform: "scaleX(-1.5)",}} > <Link to="/" className='text-gray-500 hover:text-gray-900'><FaSignOutAlt/></Link></h2>
      ...
      <div className="relative  bg-green-700 p-8 rounded-md shadow-md overflow-hidden" style={{display:"flex",height:"420px",width:"550px"}}>
      <div>
        <img src='https://i.pinimg.com/736x/06/9d/85/069d8573585d1a4b08a341f0c7d3d5ac.jpg' width='200px' style={{marginRight:"35px",height:"360px"}} />
      </div>
